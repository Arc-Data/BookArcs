    ...
    return (
        <div className="flex flex-col items-center justify-center pt-20">
            ...
            <form method="POST" onSubmit={handleSubmit} className="w-full max-w-md px-6 py-4 mt-4 border rounded-lg">
                ...
                <div className="my-3">
                    <label htmlFor="confirm_password" className="block mb-2 text-sm font-medium">Confrim Password</label>
                    <input type="password" onChange={handleChangeInput} name="confirm_password" id="email" className="bg-gray-50 border border-gray-300 text-sm text-text-default rounded-lg block w-full p-2.5" />
                </div>
                <button type="submit" className="w-full bg-primary-default mt-10 py-1.5 rounded-lg">Create</button>
